...
urlpatterns = [
     ...
     path('relatorio-estoque/', views.relatorio_estoque, name='relatorio_estoque_pdf'),
     ...
     path('relatorio-estoque/pdf/', views.relatorio_estoque_pdf, name='relatorio_estoque_pdf'),
